...
\usepackage[left=3cm,top=2.0cm,right=1cm,bottom=2cm]{geometry}
...
% Почему: Пункт 2.2.7 Требований по оформлению пояснительной записки.
\makeatletter
\renewcommand{\l@chapter}{\@dottedtocline{1}{0.5em}{1.5em}}
\renewcommand{\l@section}{\@dottedtocline{1}{2.0em}{2.0em}}
...
\renewcommand{\@makechapterhead}[1]{
  ...
  {\parindent \z@
    ...
    \ifnum \c@secnumdepth >\m@ne
        \normalfont\large\bfseries\MakeUppercase \@chapapp\space \thechapter
        \par\nobreak
        \vskip 0\p@
    \fi
    \interlinepenalty\@M
    \normalfont\large\bfseries\MakeUppercase{#1}\par\nobreak
    \vskip 1em \@plus .2ex
  }}
% \makeatletter
% \renewcommand{\@makechapterhead}[1]{% Начало макроопределения
%   \vspace*{-10pt}% Пустое место вверху страницы
%   {\parindent=0pt
...
%     \vspace{0 pt}   % между заголовком и текстом
%   }% конец группы.
...
\captionsetup[figure]{font=small,labelformat=stbfigure,justification=centering,aboveskip={26pt plus 3pt minus 2pt}}
\captionsetup[table]{font=small,labelformat=stbtable,justification=raggedright}
...
\lstdefinelanguage{PHP}
    {morekeywords={abstract,and,as,assert,base,begin,class,default,delegate,do,done,downcast,downto,elif,else,end,exception,extern,false,finally,for,fun,function,global,if,in,inherit,inline,interface,internal,lazy,let,let!,match,member,module,mutable,namespace,new,not,null,of,open,or,override,private,public,rec,return,return!,select,static,struct,then,to,true,try,type,upcast,use,use!,val,void,when,while,with,yield,yield!,asr,land,lor,lsl,lsr,lxor,mod,sig,atomic,break,checked,component,const,constraint,constructor,continue,eager,event,external,fixed,functor,include,method,mixin,object,parallel,process,protected,pure,sealed,tailcall,trait,virtual,volatile,extends,implements,require_once, unset,die,echo},
    keywordstyle=\bfseries\color{bluekeywords},
    sensitive=false,
    morecomment=[l][\color{greencomments}]{///},
    morecomment=[l][\color{greencomments}]{//},
...
% Для окружения comment
\usepackage{comment}

\newcommand{\argmax}[1]{\operatorname{arg}\,\underset{#1}{\operatorname{max}}\;}
